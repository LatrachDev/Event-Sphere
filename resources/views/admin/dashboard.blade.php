...
<body class="bg-light-background text-light-text dark:bg-dark-background dark:text-dark-text font-poppins">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-48 bg-dark-half flex flex-col">
            ...
            <!-- Navigation -->
            <nav class="flex-1">
                <a href="#" class="flex items-center py-3 px-4 text-sm text-dark-text bg-opacity-20 hover:border-l-4 border-dark-secondary hover:bg-dark-accent duration-200">
                ...
                <a href="#" class="flex items-center py-3 px-4 text-sm text-dark-text bg-opacity-20 hover:border-l-4 border-dark-secondary hover:bg-dark-accent duration-200 relative">
                    <i class="fas fa-file-invoice w-5 text-center mr-3"></i>
                    <span>Invoices</span>
                    <span class="absolute right-3 bg-dark-error text-white text-xs px-1 rounded-full">10+</span>
                </a>
            </nav>
