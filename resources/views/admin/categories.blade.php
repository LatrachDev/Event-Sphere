          ...
          <tbody>
              ...
              <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-light-hvr dark:hover:bg-dark-hvr duration-300">
                ...
                <td class="p-4 text-right">
                  <button onclick="openEditPopup('{{ $category->name }}', {{ $category->id }})" class="text-light-primary dark:text-dark-primary hover:scale-125 duration-300"><i class="fas fa-edit"></i></button>
                  
                  <form action="{{ route('categories.destroy', $category) }}" method="POST" class="inline-block">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="ml-4 text-red-500 hover:text-red-400 hover:scale-125 duration-300"><i class="fas fa-trash"></i></button>
                  </form>
