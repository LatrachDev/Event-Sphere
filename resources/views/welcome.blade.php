...
<body class="bg-light-background dark:bg-dark-background dark:text-dark-text transition-colors duration-2000">
    ...
    <section class="p-10 sm:p-20 font-poppins">
        ...
        <p class="text-center px-4 font-light text-sm sm:text-xl my-10 sm:my-10">Stay updated with the most popular events happening around you.</p>
        ...
        <div class="hidden mt-5 sm:flex items-start justify-around">
            <p class="text-center mt-8 font-medium">Browse upcoming <br> events</p>
        ...
        <div class="mt-5 flex flex-col items-center justify-center sm:hidden"> 
            ...
            <!-- arrow -->
            <div class="w-4 transform translate-y-0 my-6">
