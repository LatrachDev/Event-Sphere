...
<body class="bg-light-background dark:bg-dark-background dark:text-dark-text transition-colors duration-2000">
    ...
    <!-- how works -->
    <section class="p-10 sm:p-20 font-poppins">
        <h3 class="font-semibold text-center text-xl sm:text-2xl lg:text-4xl">How EventSphere Works</h3>
        <p class="text-center px-4 font-light text-sm sm:text-xl my-5 sm:my-10">Stay updated with the most popular events happening around you.</p>

        <!-- icons -->
         <div class="md:flex md:justify-around items-center justify-center gap-5 sm:gap-10 space-y-10 lg:space-y-0"> 
            <!-- browse -->
            <div>
                <svg class="mx-auto mt-10 w-52 h-52" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="110" cy="110" r="107.5" stroke="#C228F6" stroke-width="5" stroke-dasharray="30 30"/>
            ...
            <!-- arrow -->
            <svg class="mx-auto rotate-90 sm:rotate-0" width="24" height="27" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M24 13.5L0.750001 26.9234L0.750002 0.0766057L24 13.5Z" fill="#C228F6"/>
            </svg>

            <!-- reserve -->
            <div>
                <svg class="mx-auto w-52 h-52" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="110" cy="110" r="107.5" stroke="#C228F6" stroke-width="5" stroke-dasharray="30 30"/>
