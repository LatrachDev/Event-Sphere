...
<head>
    ...
    <title>EventSphere - Page Not Found</title>
...
<body class="bg-light-background text-center dark:bg-dark-background font-montserrat min-h-screen flex flex-col justify-between">
    ...
    <div class="flex flex-col space-y-5 items-center justify-center flex-grow">
        <h1 class="font-bold text-6xl text-light-accent dark:text-dark-accent">404</h1>
        <h2 class="font-semibold uppercase text-3xl text-light-text dark:text-dark-text">Page Not Found</h2>
