...
<head>
    ...
    <title>EventSphere - Unauthorized</title>
...
<body class="bg-light-background text-center dark:bg-dark-background font-montserrat min-h-screen flex flex-col justify-between">
    ...
    <div class="flex flex-col space-y-5 items-center justify-center flex-grow">
        <h1 class="font-bold text-6xl text-light-accent dark:text-dark-accent">500</h1>
        <h2 class="font-semibold uppercase text-3xl text-light-text dark:text-dark-text">Unauthorized</h2>

        <p class="text-xs px-4 sm:text-lg uppercase text-dark-text opacity-80 dark:text-dark-text">
            You need to log in to access this page.
        </p>

        <a href="/login" class="px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-lg font-bold bg-dark-accent text-white rounded-md hover:bg-opacity-90 transition-all duration-300 flex items-center">
