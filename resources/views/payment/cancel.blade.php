...
<head>
    ...
    <title>Payment Canceled - EventSphere</title>
...
<body class="bg-light-background dark:bg-dark-background dark:text-dark-text transition-colors duration-2000 overflow-x-hidden">
    ...
    <main class="min-h-screen flex items-center justify-center pt-32 pb-20 px-4 sm:px-6">
        <div class="bg-white dark:bg-dark-background rounded-xl shadow-2xl p-10 max-w-xl w-full text-center space-y-6 border border-red-400 dark:border-red-500">
            <div class="text-red-500 text-6xl">
                <i class="fas fa-times-circle"></i>
            </div>
            <h1 class="text-3xl font-bold text-light-text dark:text-dark-text">Payment Canceled</h1>
            <p class="text-lg text-gray-600 dark:text-gray-400">It looks like your payment was canceled. If this was a mistake, you can try again from the event page.</p>
